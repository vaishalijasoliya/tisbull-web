      ...
      <Container maxWidth="xl" className={styles.cantenar_list_caps}>
        <Toolbar disableGutters>
          ...
          >
              ...
              >
                {pages.map((page) => (
                  <MenuItem key={page} onClick={handleCloseNavMenu}>
                    <Typography
                      textAlign="center"
                      className={styles.page_listmenu}
                    >
                      {page}
                    </Typography>
                  </MenuItem>
            ...
            <div className={styles.btnicon2}>
              <Button href="./editprofileacc">
                <SettingsIcon />
              </Button>
              <Button>
              ...
              <Tooltip title="Open settings">
                <div className={styles.newbar_list}>
                  ...
                  <div className={styles.user_list}>
                    <Typography>mirav</Typography>
                  </div>
                  <div>
                    <Button
                      className={styles.alt_list_ikon}
                    ...
                    >
                      ...
                      <div>
                        <div className={styles.idname}>
                          <Typography>AL26011995</Typography>
                        </div>
