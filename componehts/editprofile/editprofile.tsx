...
const ResponsiveAppBar = (props) => {
  ...
  const setData = async (userId) => {
    ...
    if (!!patternDelete && patternDelete.status == true) {
      ...
      formik.setFieldValue(
        "date",
        moment(patternDelete.data.birth_date).format("MM/DD/YYYY")
      );
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      date: Yup.string().max(255).required("Birthdate is required"),
      Address: Yup.string().required("Address is required"),
      Gender: Yup.string().required("Duration is required"),
    }),
    onSubmit: () => {
      onLoginPress();
    },
      ...
      <form onSubmit={formik.handleSubmit} className={styles.formedit}>
        <Grid item md={12} sm={12}>
          <div className={styles.hedingdiv}>
            <div className={styles.wid_1}>
              ...
              {/* */}
              <div className={styles.uplodimgp}>
                <Typography>
                  Update your photo and personal detalis here.
                </Typography>
              </div>
            </div>
            <div className={styles.donebtn + " " + styles.wid_2}>
        ...
        <div className={styles.inputoplist}>
          <Grid item md={6} sm={12} xs={12}>
            ...
            {/* <div> */}
            <InputLabel className={styles.leballiss} htmlFor="component-simple">
              Name
            </InputLabel>
            <TextField
          ...
          <Grid item md={6} sm={12} xs={12} className={styles.mar_1}>
            {/* <div> */}
            <InputLabel className={styles.leballiss} htmlFor="component-simple">
              Email
            </InputLabel>
        ...
        <div className={styles.pohelistmenu}>
          <Grid item md={6} className={styles.wid_3}>
            <InputLabel className={styles.leballiss} htmlFor="component-simple">
              Phone no.
            </InputLabel>
            <PhoneInput
          ...
          <Grid item md={6} className={styles.mar_1 + " " + styles.wid_3 + " " + styles.mar_1}>
            <InputLabel className={styles.leballiss} htmlFor="component-simple">
              Date of Birth
            </InputLabel>
            <TextField
        ...
        <div className={styles.futtorlist}>
          ...
          <Grid item md={6} className={styles.mar_1}>
            <InputLabel className={styles.leballiss} htmlFor="component-simple">
              Gender
            </InputLabel>
            ...
            {age == "" ? (
              <div>
                <span className={styles.otperr}>Please Enter Valid Gender</span>
              </div>
            ) : (
              ""
            )}
