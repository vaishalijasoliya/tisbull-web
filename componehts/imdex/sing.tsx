...
const Home = (props) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string().max(30).required("emaika"),
      Name: Yup.string().max(30).required("emaika"),
    ...
    <Grid container className={styles.cantenar_pegsingcantenar}>
      <Grid item sm={12} md={5} xs={12} className={styles.listdataform}>
        ...
        <Box className={styles.boxsinglist2}>
          <div className={styles.welcamrlist}>
            <Typography className={styles.welcamrlist1}>Create an account</Typography>
          </div>
          <div className={styles.pleslist2}>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className={styles.fargotpasslist}>
              <div className={styles.btncekpass + " " + styles.wid_1}>
                <Button
              ...
              <div className={styles.forgotlistmenu}>
                <Link href="./forgotpass" className={styles.linkfaragot}>
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className={styles.borderimline}>
            ...
            <div className={styles.singbodar}>
          ...
          <div className={styles.alreadylist2}>
            ...
            <Typography>for free</Typography>
          </div>
        </Box>
      </Grid>
